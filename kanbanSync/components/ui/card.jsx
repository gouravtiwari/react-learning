        ...
        return (
            <div className="card">
                <div className = "card_edit">
                    ...
                    />
                    { " " }
                    <span className = "fa fa-times remove-icon"
                        // Assignment#3: part#2
                        // Since this is removeCard we need to pass in this.propsid
                        // Note:
                        // - this.props did not have removeCard, 
                        //  so it has to come from parent component, i.e. list
                        //  and list gets from kanbanBoard, which gets from app
                        onClick = {
